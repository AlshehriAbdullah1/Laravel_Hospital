<div class="m-16 px-10 border-gray-300 border-2 mt-4 rounded-md">
    ...
    <div class="mt-8 flex flex-col justify-between">
        ...
        <footer>
            <div class=" text-center justify-end">
                <div    class="rounded-md bg-blue-300 inline-block px-4 py-2 my-2 text-white hover:bg-blue-600">
